 ...
 */
@interface UITableViewCell (SFMasonryAutoCellHeight)
 ...
 */
@property (nonatomic, strong) UIView *sf_lastViewInCell;

/**
 * 可选设置的属性，默认为0，表示指定的hyb_lastViewInCell到cell的bottom的距离
 * 默认为0.0
 */
@property (nonatomic, assign) CGFloat sf_bottomOffsetToCell;
